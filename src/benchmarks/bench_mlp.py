...
for res, batch in CONFIGS:
    ...
    model = TinyNeRF(encoding.out_dim, width=MLP_WIDTH, depth=MLP_DEPTH).to(DEVICE)
    n_params = sum(p.numel() for p in model.parameters())
    print(f"  MLP width={MLP_WIDTH} depth={MLP_DEPTH}: {n_params:,} params", flush=True)
